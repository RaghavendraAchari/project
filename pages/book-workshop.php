                    ...
                    <div class="accordion"  id="accordionCollapse" >
                        <div class="card" style="border-radius : 0rem;">
                            <div class="card-header">
                                <a class="card-link" data-toggle="collapse"  href="#collapseOne">Date</a>
                            </div>
                        </div>
                        ...
                        <div class="card" style="border-radius : 0rem;">
                            <div class="card-header"><a class="card-link" href="#collapseTwo"  data-toggle="collapse" >Time</a></div>             
                        </div>    
